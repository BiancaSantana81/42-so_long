...
/*   Updated: 2024/02/29 18:55:53 by bsantana         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	side(t_game *game, char side)
{
	if (side == 'l')
	{
		...
		game->player_data_move->img->instances[0].x -= BLOCK;
		game->player_data_move_l->img->instances[0].x -= BLOCK;
	}
	if (side == 'r')
	{
		game->side = '>';
...
void	move_player(t_game *game, char mov)
{
	...
	if (mov == 's')
	{
		...
		game->player_data_move->img->instances[0].y += BLOCK;
		game->player_data_move_l->img->instances[0].y += BLOCK;
	}
	else if (mov == 'w')
	{
		game->player_data->img->instances[0].y -= BLOCK;
